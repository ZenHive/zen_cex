defmodule ZenCex.Adapters.Binance.Spot do
  ...
  # IMPORTANT: :get_account and :get_balances are SEPARATE operations.
  # - :get_account returns the full account response (includes userId, accountType, etc.)
  # - :get_balances returns ONLY the balances array (parsed by parse_balances)
  ...
  # get_account/2 is generated by EndpointRegistry from generated_endpoints.ex
# It returns the full account response including uid, account_type, permissions, etc.
