...
[
  ...
  %{
    ...
    response_parser: &Parser.parse_generic/1,
    error_mapping: &Parser.parse_error/1,
    doc: "Close Margin User Data Stream (USER_STREAM)"
  },
  %{
    operation: :update,
    method: :put,
    ...
    response_parser: &Parser.parse_generic/1,
    error_mapping: &Parser.parse_error/1,
    doc: "Keepalive Margin User Data Stream (USER_STREAM)"
  },
  %{
    operation: :place,
    method: :post,
    ...
    response_parser: &Parser.parse_generic/1,
    error_mapping: &Parser.parse_error/1,
    doc: "Start Margin User Data Stream (USER_STREAM)"
  },
  %{
    operation: :cancel_isolated,
    method: :delete,
    ...
    response_parser: &Parser.parse_generic/1,
    error_mapping: &Parser.parse_error/1,
    doc: "Close Isolated Margin User Data Stream (USER_STREAM)"
  },
  %{
    operation: :update_isolated,
    method: :put,
    path: "/sapi/v1/userDataStream/isolated",
    requires_auth: true,
    weight: 1,
    ...
    response_parser: &Parser.parse_generic/1,
    error_mapping: &Parser.parse_error/1,
    doc: "Keepalive Isolated Margin User Data Stream (USER_STREAM)"
  },
  %{
    operation: :place_isolated,
    method: :post,
    path: "/sapi/v1/userDataStream/isolated",
    requires_auth: true,
    weight: 1,
    ...
    response_parser: &Parser.parse_generic/1,
    error_mapping: &Parser.parse_error/1,
    doc: "Start Isolated Margin User Data Stream (USER_STREAM)"
  },
  %{
